...
set ylabel "Rainfall (mm)${varname[${ivar}]}" font ",25"
...
#set arrow 1 from graph 0,first ${linepos} to graph 1, first ${linepos} as 1 front
...
plot  "${FNameOut}.txt" u 1:2 w l ls 7 title 'Observation',\
      "${FNameOut}.txt" u 1:3 w l ls 2 title 'EN',\
      "${FNameOut}.txt" u 1:4 w l ls 3 title 'EnFY'
